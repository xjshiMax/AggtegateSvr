...
class structreject:
    ...
    def __init__(self,sourceRecord):
        ...
        self.timestamp1 = int(time.mktime(time.strptime(self.time, "%Y-%m-%d %H:%M:%S")))
        self.timestamp2 = int(time.mktime(time.strptime(self.time, "%Y-%m-%d %H:%M:%S")))
        self.timestamp3 = int(time.mktime(time.strptime(self.time, "%Y-%m-%d %H:%M:%S")))
